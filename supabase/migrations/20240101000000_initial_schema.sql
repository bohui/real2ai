...
GRANT EXECUTE ON FUNCTION discover_recoverable_tasks TO service_role;
GRANT EXECUTE ON FUNCTION validate_task_recovery TO service_role;
GRANT EXECUTE ON FUNCTION upsert_task_registry TO service_role;
GRANT EXECUTE ON FUNCTION update_task_registry_state TO service_role;
GRANT EXECUTE ON FUNCTION create_task_checkpoint TO service_role;
GRANT EXECUTE ON FUNCTION get_latest_checkpoint TO service_role;
GRANT EXECUTE ON FUNCTION add_to_recovery_queue TO service_role;
...
-- RLS Policies for task recovery tables
...
-- Grant permissions for task recovery tables
