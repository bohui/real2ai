...
const SettingsPage: React.FC = () => {
  ...
  // Form states
  const [activeTab, setActiveTab] = React.useState<'profile' | 'notifications' | 'security' | 'billing'>('profile')
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div>
                        ...
                        <select
                          ...
                          onChange={(e) => setProfileForm({...profileForm, australian_state: e.target.value as AustralianState})}
              ...
              <Card>
                ...
                <CardContent>
                  <div className="space-y-6">
                        ...
                        <div key={key} className="flex items-center justify-between py-3 border-b border-neutral-100 last:border-b-0">
                          <div>
                            ...
                            <div className="text-sm text-neutral-500">
                              {key === 'analysis_complete' && 'Get notified when your contract analysis is complete'}
                              {key === 'weekly_summary' && 'Weekly summary of your analysis activity'}
                              {key === 'security_alerts' && 'Important security and account alerts'}
                              {key === 'product_updates' && 'New features and product announcements'}
                              {key === 'marketing_emails' && 'Tips, case studies, and promotional content'}
                            </div>
                          </div>
                    ...
                    <div className="flex justify-end">
                      <Button onClick={handleNotificationUpdate} variant="primary" leftIcon={<Save className="w-4 h-4" />}>
                        Save Preferences
                      </Button>
                    </div>
                  </div>
                ...
                <Card>
                  ...
                  <CardContent>
                    <form onSubmit={handlePasswordChange} className="space-y-6">
                      ...
                      <div className="flex justify-end">
                        <Button type="submit" variant="primary" leftIcon={<Key className="w-4 h-4" />}>
                          Update Password
                        </Button>
                      </div>
                    </form>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center justify-between py-3 border-b border-neutral-100">
                        <div>
                          ...
                          <div className="text-sm text-neutral-500">Manage your active login sessions</div>
                        </div>
                        <Button variant="outline" size="sm">
                          View Sessions
                        </Button>
                      ...
                      <div className="flex items-center justify-between py-3">
                        <div>
                          <div className="font-medium text-neutral-900">Download Account Data</div>
                          <div className="text-sm text-neutral-500">Export all your account data and analyses</div>
                        </div>
                        <Button variant="outline" size="sm">
                          Download
                        </Button>
                  ...
                  <CardContent>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                      <div className="text-center">
                        ...
                        <div className="text-sm text-neutral-500">Analyses This Month</div>
                      </div>
                      <div className="text-center">
                        <div className="text-2xl font-bold text-success-600">96</div>
                        <div className="text-sm text-neutral-500">Credits Used</div>
                      </div>
                      <div className="text-center">
                        <div className="text-2xl font-bold text-warning-600">4</div>
