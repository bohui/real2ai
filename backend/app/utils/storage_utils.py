...
class ArtifactStorageService:
    ...
    async def upload_page_text(
        self, page_text: str, content_hmac: str, page_number: int
    ) -> Tuple[str, str]:
        """
    ...
    async def upload_page_markdown(
        self, markdown_bytes: bytes, content_hmac: str, page_number: int
    ) -> Tuple[str, str]:
        """
    ...
    async def upload_page_image_jpg(
        self, image_bytes: bytes, content_hmac: str, page_number: int
    ) -> Tuple[str, str]:
        """
