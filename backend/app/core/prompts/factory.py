    ...
    async def create_and_initialize(
        ...
        **overrides
        ...
        if factory_method == 'minimal':
            ...
            manager = factory_methods[factory_method](templates_dir, config_dir, **overrides)
        
        # Initialize async components
        await manager.initialize()
        
        logger.info(f"PromptManager created and initialized using '{factory_method}' configuration")
