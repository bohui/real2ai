...
class ContractAnalysisServiceV2:
        ...
        try:
            ...
            if not self.gemini_client:
                raise ClientConnectionError(
                    ...
                    client_name="ContractAnalysisServiceV2"
                )
    ...
    async def analyze_contract(
        ...
        if not self.gemini_client:
            raise HTTPException(
                status_code=503,
                detail="AI analysis service not initialized"
            )
        ...
        try:
            ...
            try:
                ...
                auth_method = client_health.get("authentication", {}).get("method", "unknown")
            except Exception:
                pass
    ...
    async def health_check(self) -> Dict[str, Any]:
        ...
        if self.gemini_client:
            try:
                ...
                health_status["authentication_method"] = (
