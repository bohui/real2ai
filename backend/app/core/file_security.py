...
class FileSecurityValidator:
    ...
    async def validate_file_security(
        ...
        try:
            ...
            magic_bytes_result = self._validate_magic_bytes(file_content, file_extension)
            ...
            return SecurityValidationResult(
                ...
                metadata={
                    ...
                    "file_hash": file_hash,
                    "file_size": file_size,
                    "detected_mime_type": mime_result.metadata.get("detected_mime_type"),
                    "validation_checks_passed": [
                        "filename", "extension", "size", "mime_type", 
                        "magic_bytes", "content_scan"
                    ]
                }
            )
    ...
    def _validate_file_extension(self, filename: str) -> SecurityValidationResult:
        ...
        if not extension:
            return SecurityValidationResult(
                is_valid=False,
                error_message="File must have a valid extension"
            )
    ...
    def _validate_mime_type(self, content: bytes, file_extension: str) -> SecurityValidationResult:
        ...
        try:
            ...
            return SecurityValidationResult(
                is_valid=False,
                error_message=f"Failed to validate file type: {str(e)}"
            )
    
    def _validate_magic_bytes(self, content: bytes, file_extension: str) -> SecurityValidationResult:
    ...
    def _is_acceptable_mime_mismatch(self, detected_mime: str, file_extension: str) -> bool:
