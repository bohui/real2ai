...
from app.core.prompts.parsers import StreamingOutputParser, OutputFormat
...
class ComplexTestModel(BaseModel):
    ...
    nested_data: Optional["NestedModel"] = Field(
        None, description="Nested data structure"
    )
...
class TestPydanticOutputParser:
    ...
    def test_parse_valid_json(self):
        ...
        valid_json = json.dumps({"name": "test_item", "value": 42, "active": True})
    ...
    def test_parse_invalid_json(self):
        ...
        invalid_json = (
            '{"name": "test", "value": 42, "active": true'  # Missing closing brace
        )
    ...
    def test_non_strict_mode(self):
        ...
        incomplete_json = json.dumps({"value": 42, "active": True})
    ...
    def test_confidence_score_calculation(self):
        ...
        complete_json = json.dumps(
            {"name": "confidence_test", "value": 100, "active": True}
        )
...
class TestPerformance:
    ...
    def test_parsing_performance(self, simple_parser):
        ...
        json_data = json.dumps(
            {"name": "performance_test", "value": 123, "active": True}
        )
