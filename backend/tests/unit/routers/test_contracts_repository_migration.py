...
class TestContractsRouterMigration:
    ...
    async def test_get_user_document_success(self):
        ...
        with patch('app.router.contracts.DocumentsRepository', return_value=mock_docs_repo):
    ...
    async def test_get_user_document_not_found(self):
        ...
        with patch('app.router.contracts.DocumentsRepository', return_value=mock_docs_repo):
            with pytest.raises(ValueError, match="Document not found or you don't have access to it"):
    ...
    async def test_backward_compatibility_data_format(self):
        ...
        expected_fields = [
            ...
            "file_type", "file_size", "content_hash", "processing_status"
        ]
