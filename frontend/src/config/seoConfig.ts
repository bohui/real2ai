...
export const SEO_CONFIG = {
  ...
  titleSeparator: ' - ',
  defaultDescription: 'Advanced AI-powered real estate contract analysis and property intelligence for Australian professionals.',
...
export const SEO_TEMPLATES = {
  contractAnalysis: {
    ...
    keywords: (address?: string) => [
      ...
      'legal analysis',
      ...(address ? [`${address} contract`, `${address} property analysis`] : [])
    ]
  },
  ...
  financialAnalysis: {
    ...
    description: 'Advanced financial analysis for real estate investments. Calculate ROI, cash flow, and investment potential with AI-powered insights for Australian properties.',
    keywords: [
      'financial analysis',
      'real estate ROI',
...
export const PAGE_SEO_CONFIG: Record<string, SEOData> = {
  ...
  '/app/analysis': {
    ...
    description: 'Analyze real estate contracts with AI-powered insights, risk assessment, and compliance checks. Professional tools for Australian property law.',
    keywords: [
      'contract analysis',
      'AI analysis',
  ...
  '/app/market-analysis': {
    ...
    description: 'Advanced market analysis for Australian real estate. Trends, forecasts, and insights powered by AI to guide your property investment decisions.',
    keywords: [
      'market analysis',
      'real estate trends',
      'property market',
...
export const generateArticleStructuredData = (
  ...
  headline: title,
  description,
  image: image ? `${SEO_CONFIG.baseUrl}${image}` : `${SEO_CONFIG.baseUrl}${SEO_CONFIG.defaultImage}`,
...
export const generateSEOData = (
  ...
  if (dynamicData) {
    ...
    if (path.includes('/analysis') && !dynamicConfig.title) {
      ...
      dynamicConfig.description = SEO_TEMPLATES.contractAnalysis.description(address, riskScore);
    ...
    if (path.includes('/property-intelligence') && !dynamicConfig.title) {
      dynamicConfig.title = SEO_TEMPLATES.propertyIntelligence.title(suburb, state);
      dynamicConfig.description = SEO_TEMPLATES.propertyIntelligence.description(suburb, state, medianPrice);
      dynamicConfig.keywords = SEO_TEMPLATES.propertyIntelligence.keywords(suburb, state);
    }

    if (path.includes('/market-analysis') && !dynamicConfig.title) {
      dynamicConfig.title = SEO_TEMPLATES.marketAnalysis.title(region);
      dynamicConfig.description = SEO_TEMPLATES.marketAnalysis.description(region, trend);
  ...
  return {
    ...
    ogDescription: dynamicConfig.description || baseConfig.ogDescription || baseConfig.description
  };
};
