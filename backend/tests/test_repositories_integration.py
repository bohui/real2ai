...
class TestRLSEnforcement:
    ...
    async def test_user_isolation(self, cleanup_pools):
        ...
        try:
            ...
            user1_doc_ids = [doc.id for doc in user2_documents if doc.id == user1_document.id]
            ...
            assert user1_doc_via_user2 is None, "User2 should not access User1's document by ID"
