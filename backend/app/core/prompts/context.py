    ...
    def validate_required(self, required_vars: List[str]) -> None:
        ...
        if missing:
            raise PromptContextError(
                ...
                details={"missing_variables": missing, "available_variables": list(self.variables.keys())}
            )
...
class ContextBuilder:
    ...
    def with_australian_context(self, state: AustralianState, contract_type: ContractType) -> 'ContextBuilder':
        """Add Australian-specific context"""
        self._context.australian_state = state
        self._context.contract_type = contract_type
        return self
    
    def with_user_context(self, user_id: str, user_type: str, experience: str) -> 'ContextBuilder':
        """Add user context"""
    ...
    def with_document_context(self, doc_id: str, doc_type: str, metadata: Dict[str, Any] = None) -> 'ContextBuilder':
    ...
    def with_processing_context(self, priority: str, depth: str, focus_areas: List[str] = None) -> 'ContextBuilder':
...
class ContextPresets:
    ...
    def contract_analysis(
        ...
        return (
            ...
            .with_australian_context(australian_state, contract_type)
