...
class ClientFactory:
    ...
    def register_client(self, name: str, client_class: Type[BaseClient], config_class: Type = None) -> None:
    ...
    def _load_config(self, client_name: str) -> Any:
        ...
        if client_name not in self._config_classes:
            raise ClientError(f"No configuration class registered for client: {client_name}")
    ...
    def get_client_info(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "client_details": {
                name: client.get_client_info() if client.is_initialized else {"status": "not_initialized"}
                for name, client in self._clients.items()
            }
        }
