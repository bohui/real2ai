...
class TestPropertyProfileIntegration:
    ...
    async def mock_domain_client(self):
        ...
        client.search_properties = AsyncMock(return_value={
            "results": [{
        ...
        client.get_property_details = AsyncMock(return_value={
            "id": "domain_property_123",
            "address": "123 Collins Street, Melbourne VIC 3000",
            "property_type": "apartment",
            "bedrooms": 2,
        ...
        # Mock sales history
        client.get_sales_history = AsyncMock(return_value=[
            {
    ...
    async def mock_corelogic_client(self):
        ...
        client.get_property_valuation = AsyncMock(return_value={
        ...
        client.get_market_analytics = AsyncMock(return_value={
        ...
        client.get_property_risk_assessment = AsyncMock(return_value={
            "overall_risk_score": 6.2,
            "risk_level": "medium",
            "risk_factors": {
                "market_risk": {"score": 5.8, "factors": ["price_volatility"]},
                "environmental_risk": {"score": 3.2, "factors": ["flood_zone"]},
                "structural_risk": {"score": 2.1, "factors": []},
                "location_risk": {"score": 4.5, "factors": ["traffic_noise"]}
            },
            "recommendations": [
        ...
        client.calculate_investment_yield = AsyncMock(return_value={
            "gross_yield": 4.2,
            "net_yield": 3.1,
            "cash_flow": -12000,
            "roi_metrics": {
            ...
            "tax_implications": {
                "depreciation_benefit": 8500
            }
        })
        
        # Mock comparable sales
        client.get_comparable_sales = AsyncMock(return_value={
            "comparable_count": 6,
            "comparables": [
                {
            ...
            "analysis_summary": {
                "median_price": 847500,
                "price_range": {"min": 795000, "max": 920000},
    ...
    async def test_complete_property_profile_generation(
        ...
        with patch('app.services.property_profile_service.get_domain_client', 
                  return_value=mock_domain_client), \
             patch('app.services.property_profile_service.get_corelogic_client',
            ...
            assert profile.data_quality_score > 0.7  # Should be high with good mock data
    ...
    async def test_property_comparison(
        ...
        mock_corelogic_client.get_property_valuation.side_effect = corelogic_valuation_side_effect
    ...
    async def test_data_quality_scoring(self, property_service):
        ...
        quality_score = property_service._calculate_data_quality_score(high_quality_response)
        ...
        low_quality_score = property_service._calculate_data_quality_score(low_quality_response)
    ...
    async def test_cost_calculation(
        ...
        with patch('app.services.property_profile_service.get_domain_client',
            ...
            basic_profile = await property_service.generate_property_profile(basic_request)
            ...
            premium_profile = await property_service.generate_property_profile(premium_request)
