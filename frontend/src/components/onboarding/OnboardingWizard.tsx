  ...
  const steps: OnboardingStep[] = [
    {
      ...
      subtitle:
        "AI-powered contract analysis for Australian legal professionals",
      icon: Shield,
      content: (
        <div className="text-center space-y-6">
          ...
          <div className="space-y-4">
            <p className="text-lg text-neutral-700">
              Real2.AI uses advanced AI to analyse contracts against Australian
              law, helping you identify risks and ensure compliance faster than
              ever.
            </p>
                    ...
                    onChange={(e) => {
                      if (e.target.checked) {
                        ...
                        setPreferences((prev) => ({
                          ...prev,
                          primaryContractTypes:
                            prev.primaryContractTypes.filter((t) => t !== type),
                        }));
                      }
                    }}
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between p-4 bg-white rounded-lg border">
                <div>
                  ...
                  <p className="text-sm text-neutral-600">
                    Medium Risk - Above average for VIC property contracts
                  </p>
                </div>
              ...
              <div className="p-4 bg-primary-50 rounded-lg border border-primary-200">
                ...
                <p className="text-sm text-primary-800">
                  Review settlement terms in clause 14.3 for compliance with
                  Property Law Act 1958 (VIC). Consider adding standard
                  financing conditions similar to precedent in Chen v Melbourne
                  Property (2023).
                </p>
              </div>
            </div>
    ...
    },
    {
      ...
      content: (
        <div className="text-center space-y-6">
          ...
          <div className="space-y-4">
            <p className="text-lg text-neutral-700">
              Your personalized Real2.AI workspace is ready. Upload your first
              contract to see our AI analysis in action.
            </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-left">
                <div>
                  ...
                  <div className="font-medium text-neutral-900">
                    {practiceAreas.find(
                      (a) => a.value === preferences.practiceArea
                    )?.label || "Not selected"}
                  </div>
                </div>
                <div>
                  ...
                  <div className="font-medium text-neutral-900">
                    {jurisdictions.find(
                      (j) => j.value === preferences.jurisdiction
                    )?.label || "Not selected"}
                  </div>
                </div>
                <div>
                  ...
                  <div className="font-medium text-neutral-900">
                    {firmSizes.find((s) => s.value === preferences.firmSize)
                      ?.label || "Not selected"}
                  </div>
                </div>
                <div>
