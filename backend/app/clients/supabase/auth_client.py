...
class SupabaseAuthClient(AuthOperations):
    ...
    async def get_user(self, user_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            result = self.supabase_client.table("profiles").select("*").eq("id", user_id).execute()
    ...
    async def create_user(self, user_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            self.logger.debug(f"Creating user account: {user_data.get('email', 'no-email')}")
    ...
    async def update_user(self, user_id: str, user_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            profile_data = {k: v for k, v in user_data.items() if k not in ['email', 'password', 'phone']}
            
            if profile_data:
                result = self.supabase_client.table("profiles").update(profile_data).eq("id", user_id).execute()
    ...
    async def delete_user(self, user_id: str) -> bool:
        ...
        try:
            ...
            result = self.supabase_client.table("profiles").update({
                "deleted_at": "now()",
                "status": "deleted"
