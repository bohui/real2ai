...
export function generateArticleData(data: ArticleData) {
  return {
    ...
    keywords: data.tags?.join(", ") ||
      "real estate, AI analysis, property intelligence",
    inLanguage: "en-AU",
  };
}
...
export function generateServiceData() {
  return {
    ...
    description:
      "Comprehensive AI-driven contract analysis and property intelligence for Australian real estate professionals.",
...
export function generateSoftwareApplicationData() {
  return {
    ...
    name: "Real2AI",
    description:
      "AI-powered real estate contract analysis and property intelligence platform",
