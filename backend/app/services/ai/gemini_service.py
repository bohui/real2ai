...
class GeminiService(UserAwareService):
        ...
        **kwargs
        ...
        try:
            ...
            if not language and "text" in result:
                result["detected_language"] = await self._detect_language(result["text"])
    ...
    async def summarize_content(
        ...
        **kwargs
        ...
        try:
            ...
            summary = await self.generate_content(prompt, temperature=0.3)
    ...
    def _parse_sentiment_response(self, response: str, granularity: str) -> Dict[str, Any]:
