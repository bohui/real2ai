...
def test_rate_limiter():
    ...
    try:
        from app.clients.domain.rate_limiter import (
            AdaptiveRateLimiter,
            RateLimitManager,
        )
        ...
        limiter = AdaptiveRateLimiter(
            requests_per_minute=100, requests_per_second=2.0, burst_allowance=10
        )
        ...
        manager = RateLimitManager(
            {"requests_per_minute": 100, "requests_per_second": 2.0}
        )
...
def test_models_integration():
    ...
    try:
        from app.schema import PropertyAddress, PropertyDetails, AustralianState
        ...
        details = PropertyDetails(property_type="House", bedrooms=3, bathrooms=2)
