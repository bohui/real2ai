...
class Contract(TimestampedBaseModel):
    ...
    contract_type: Optional[ContractType] = ContractType.UNKNOWN
    ...
    state: Optional[AustralianState] = AustralianState.NSW
    ...
    buyer_report: Dict[str, Any] = Field(default_factory=dict)
